  ...
  return (
    <div className="flex flex-col min-h-screen pt-24">
      <div
        ...
        style={{
          backgroundImage: 'url("/IMG_8386.JPG")',
      ...
      <motion.section
        ...
        className="relative z-10 flex-1 container mx-auto px-4 py-12"
      >
        <h1 className="text-5xl md:text-6xl font-bold mb-8 text-center text-white">
        ...
        <div className="grid md:grid-cols-2 gap-12 max-w-4xl mx-auto">
          <div className="space-y-8 bg-zinc-900/80 backdrop-blur-md p-8 rounded-2xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-6 bg-zinc-900/80 backdrop-blur-md p-8 rounded-2xl">
